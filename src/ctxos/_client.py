...
if TYPE_CHECKING:
    from .resources import tokens, complete
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Ctxos", "AsyncCtxos", "Client", "AsyncClient"]


class Ctxos(SyncAPIClient):
    # client options
    api_key: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Ctxos client instance.

        This automatically infers the `api_key` argument from the `CTXOS_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("CTXOS_API_KEY")
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("CTXOS_BASE_URL")
        if base_url is None:
            base_url = f"https://ctxos.github.io"
    ...
    @cached_property
    def with_raw_response(self) -> CtxosWithRawResponse:
        return CtxosWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> CtxosWithStreamedResponse:
        return CtxosWithStreamedResponse(self)
...
class AsyncCtxos(AsyncAPIClient):
    # client options
    api_key: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncCtxos client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncCtxosWithRawResponse:
        return AsyncCtxosWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncCtxosWithStreamedResponse:
        return AsyncCtxosWithStreamedResponse(self)
...
class CtxosWithRawResponse:
    _client: Ctxos

    def __init__(self, client: Ctxos) -> None:
        self._client = client
...
class AsyncCtxosWithRawResponse:
    _client: AsyncCtxos

    def __init__(self, client: AsyncCtxos) -> None:
        self._client = client
...
class CtxosWithStreamedResponse:
    _client: Ctxos
...
class AsyncCtxosWithStreamedResponse:
    _client: AsyncCtxos
