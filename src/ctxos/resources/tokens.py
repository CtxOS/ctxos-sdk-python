...
class TokensResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> TokensResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/ctxos-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> TokensResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/ctxos-python#with_streaming_response
        """
